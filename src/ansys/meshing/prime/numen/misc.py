...
def read(model: prime.Model, read_params: dict, cached_data: CachedData):
    ...
    if os.name == "nt":
        supported_cad_formats = [".scdoc", ".fmd", ".agdb", ".pmdb", ".meshdat", ".mechdat",
                                ".dsdb", ".cmdb", ".sat", ".sab", ".dwg", ".dxf", ".model",
                                ".exp", ".CATPart", ".CATProduct", ".cgr", ".3dxml", ".iges",
                                ".igs", ".ipt", ".iam", ".jt", ".prt", ".x_t", ".x_b", ".par",
                                ".psm", ".asm", ".sldprt", ".sldasm", ".step", ".stp", ".stl",
                                ".plmxml", ".tgf", ".dsco", ".scdocx"]
    else:
        supported_cad_formats = [".fmd", ".agdb", ".pmdb", ".meshdat", ".mechdat", ".dsdb",
                                 ".cmdb", ".sat", ".sab", ".CATPart", ".CATProduct", ".iges",
                                 ".igs", ".jt", ".x_t", ".x_b", ".step", ".stp", ".stl",
                                 ".plmxml", ".tgf", ".dsco"]
    ...
    model._comm.serve(model, "PrimeMesh::Model/EnableLocalGSProjectionMethod",
                      model._object_id, args={})
...
def create_labels_per_part_entities(model: prime.Model, create_labels_params: dict,
