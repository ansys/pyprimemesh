...
class TriangulateParams(CoreObject):
    ...
    def __init__(
            ...
            json_data : dict = None,
             **kwargs):
        """Initializes the TriangulateParams.
    ...
    @staticmethod
    def set_default():
        """Set the default values of TriangulateParams.
...
class TriangulateResults(CoreObject):
    ...
    def __init__(
            ...
            json_data : dict = None,
             **kwargs):
        """Initializes the TriangulateResults.
    ...
    def set_default(
            error_code: ErrorCode = None,
            n_faces_triangulated: int = None):
        """Set the default values of TriangulateResults.
