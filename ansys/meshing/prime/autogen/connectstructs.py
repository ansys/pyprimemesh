...
class ConnectResults(CoreObject):
    ...
    def set_default(
            error_code: ErrorCode = None):
        """Sets the default values of ConnectResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ConnectResults.
...
class IntersectParams(CoreObject):
    ...
    def set_default(
            ...
            use_absolute_tolerance: bool = None,
            remesh: bool = None):
        """Sets the default values of IntersectParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of IntersectParams.
...
class JoinParams(CoreObject):
    ...
    def __init__(
        ...
        if json_data:
            ...
            all_field_specified = all(arg is not None for arg in [tolerance, use_absolute_tolerance, remesh, overlap_zone_name])
            if all_field_specified:
                self.__initialize(
                    tolerance,
                    use_absolute_tolerance,
    ...
    def set_default(
            ...
            remesh: bool = None,
            overlap_zone_name: str = None):
        """Sets the default values of JoinParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of JoinParams.
    ...
    def __str__(self) -> str:
        message = "tolerance :  %s\nuse_absolute_tolerance :  %s\nremesh :  %s\noverlap_zone_name :  %s" % (self._tolerance, self._use_absolute_tolerance, self._remesh, self._overlap_zone_name)
        message += ''.join('\n' + str(key) + ' : ' + str(value) for key, value in self._custom_params.items())
        return message
...
class StitchParams(CoreObject):
    ...
    def set_default(
            ...
            enable_multi_threading: bool = None,
            type: StitchType = None):
        """Sets the default values of StitchParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of StitchParams.
