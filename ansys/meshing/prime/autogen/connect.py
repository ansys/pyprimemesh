...
class Connect(CoreObject):
    """Connects face zonelets.

    Performs surface connections using various connect algorithms on face zonelets.
    For example, face zonelet intersection.
    """
    ...
    def stitch_face_zonelets(self, part_id : int, face_zonelet_ids : Iterable[int], with_face_zonelet_ids : Iterable[int], params : StitchParams) -> ConnectResults:
        """ Stitchs a set of face zonelets with another set of face zones.
