...
class TransformResults(CoreObject):
    ...
    def set_default(
            error_code: ErrorCode = None):
        """Sets the default values of TransformResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of TransformResults.
...
class TransformParams(CoreObject):
    ...
    def set_default(
            transformation_matrix: Iterable[float] = None):
        """Sets the default values of TransformParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of TransformParams.
