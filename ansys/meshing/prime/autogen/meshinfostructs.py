...
class FaceConnectivityResults(CoreObject):
    ...
    @staticmethod
    def print_default():
        """Prints the default values of FaceConnectivityResults.
...
class EdgeConnectivityResults(CoreObject):
    ...
    @staticmethod
    def print_default():
        """Prints the default values of EdgeConnectivityResults.
...
class FaceAndEdgeConnectivityResults(CoreObject):
    ...
    @staticmethod
    def print_default():
        """Prints the default values of FaceAndEdgeConnectivityResults.
...
class FaceAndEdgeConnectivityParams(CoreObject):
    ...
    def set_default(
            reorder_face_zonelets_mid_nodes: bool = None,
            reorder_edge_zonelets_mid_nodes: bool = None):
        """Sets the default values of FaceAndEdgeConnectivityParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of FaceAndEdgeConnectivityParams.
