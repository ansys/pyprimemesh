...
class VolumeQualityResultsPart(CoreObject):
    ...
    def set_default(
            ...
            max_quality: float = None,
            min_quality: float = None):
        """Sets the default values of VolumeQualityResultsPart.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of VolumeQualityResultsPart.
...
class VolumeQualitySummaryResults(CoreObject):
    ...
    def set_default(
            ...
            quality_results_part: List[VolumeQualityResultsPart] = None,
            message: str = None):
        """Sets the default values of VolumeQualitySummaryResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of VolumeQualitySummaryResults.
...
class VolumeQualitySummaryParams(CoreObject):
    ...
    def set_default(
            ...
            scope: ScopeDefinition = None,
            quality_limit: Iterable[float] = None):
        """Sets the default values of VolumeQualitySummaryParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of VolumeQualitySummaryParams.
