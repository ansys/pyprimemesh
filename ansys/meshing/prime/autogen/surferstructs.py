...
class LocalSurferParams(CoreObject):
    ...
    def set_default(
            ...
            smooth_boundary: bool = None,
            n_rings: int = None):
        """Sets the default values of LocalSurferParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of LocalSurferParams.
...
class LocalSurferResults(CoreObject):
    ...
    def set_default(
            error_code: ErrorCode = None,
            warning_codes: List[WarningCode] = None):
        """Sets the default values of LocalSurferResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of LocalSurferResults.
