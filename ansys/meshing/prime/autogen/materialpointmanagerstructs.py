...
class CreateMaterialPointParams(CoreObject):
    ...
    def set_default(
            type: MaterialPointType = None):
        """Sets the default values of CreateMaterialPointParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of CreateMaterialPointParams.
...
class CreateMaterialPointResults(CoreObject):
    ...
    def set_default(
            ...
            error_code: ErrorCode = None,
            warning_codes: List[WarningCode] = None):
        """Sets the default values of CreateMaterialPointResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of CreateMaterialPointResults.
