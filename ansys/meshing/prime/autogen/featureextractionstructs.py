...
class ExtractFeatureParams(CoreObject):
    ...
    def set_default(
            ...
            disconnect_with_faces: bool = None,
            label_name: str = None):
        """Sets the default values of ExtractFeatureParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ExtractFeatureParams.
...
class ExtractFeatureResults(CoreObject):
    ...
    def set_default(
            ...
            error_code: ErrorCode = None,
            new_edge_zonelets: Iterable[int] = None):
        """Sets the default values of ExtractFeatureResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ExtractFeatureResults.
...
class ExtractedFeatureIds(CoreObject):
    ...
    def set_default(
            part_id: int = None,
            new_edge_zonelets: Iterable[int] = None):
        """Sets the default values of ExtractedFeatureIds.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ExtractedFeatureIds.
...
class CreateIntersectionEdgeLoopsParams(CoreObject):
    ...
    def set_default(
            label_name: str = None):
        """Sets the default values of CreateIntersectionEdgeLoopsParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of CreateIntersectionEdgeLoopsParams.
...
class CreateIntersectionEdgeLoopsResults(CoreObject):
    ...
    def set_default(
            ...
            error_code: ErrorCode = None,
            extracted_ids: List[ExtractedFeatureIds] = None):
        """Sets the default values of CreateIntersectionEdgeLoopsResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of CreateIntersectionEdgeLoopsResults.
