...
class DeleteFringesAndOverlapsParams(CoreObject):
    ...
    def set_default(
            ...
            delete_fringes: bool = None,
            delete_overlaps: bool = None):
        """Sets the default values of DeleteFringesAndOverlapsParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of DeleteFringesAndOverlapsParams.
...
class DeleteFringesAndOverlapsResults(CoreObject):
    ...
    def set_default(
            error_code: ErrorCode = None,
            n_deleted: int = None):
        """Sets the default values of DeleteFringesAndOverlapsResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of DeleteFringesAndOverlapsResults.
