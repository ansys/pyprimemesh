...
class ScaffolderParams(CoreObject):
    ...
    def set_default(
            ...
            intersection_control_mask: IntersectionMask = None,
            constant_mesh_size: float = None):
        """Sets the default values of ScaffolderParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ScaffolderParams.
...
class VolumetricScaffolderParams(CoreObject):
    ...
    def set_default(
            absolute_dist_tol: float = None,
            only_check_exact_overlaps: bool = None):
        """Sets the default values of VolumetricScaffolderParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of VolumetricScaffolderParams.
...
class ScaffolderResults(CoreObject):
    ...
    def set_default(
            n_incomplete_topo_faces: int = None,
            error_code: ErrorCode = None):
        """Sets the default values of ScaffolderResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ScaffolderResults.
...
class ScaffolderSplitResults(CoreObject):
    ...
    def set_default(
            new_faces: Iterable[int] = None,
            error_code: ErrorCode = None):
        """Sets the default values of ScaffolderSplitResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ScaffolderSplitResults.
...
class ScaffolderMergeResults(CoreObject):
    ...
    def set_default(
            n_merged: int = None,
            error_code: ErrorCode = None):
        """Sets the default values of ScaffolderMergeResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of ScaffolderMergeResults.
