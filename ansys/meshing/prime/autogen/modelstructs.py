...
class MergePartsParams(CoreObject):
    ...
    def set_default(
            merged_part_suggested_name: str = None):
        """Sets the default values of MergePartsParams.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of MergePartsParams.
...
class MergePartsResults(CoreObject):
    ...
    def set_default(
            ...
            merged_part_assigned_name: str = None,
            merged_part_id: int = None):
        """Sets the default values of MergePartsResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of MergePartsResults.
...
class CreateZoneResults(CoreObject):
    ...
    def set_default(
            ...
            zone_id: int = None,
            assigned_name: str = None):
        """Sets the default values of CreateZoneResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of CreateZoneResults.
...
class DeleteZoneResults(CoreObject):
    ...
    def set_default(
            error_code: ErrorCode = None):
        """Sets the default values of DeleteZoneResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of DeleteZoneResults.
