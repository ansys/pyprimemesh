...
class PartZonelets(CoreObject):
    ...
    def set_default(
            part_id: int = None,
            face_zonelets: Iterable[int] = None):
        """Sets the default values of PartZonelets.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of PartZonelets.
...
class DeleteResults(CoreObject):
    ...
    def set_default(
            error_code: ErrorCode = None):
        """Sets the default values of DeleteResults.
    ...
    @staticmethod
    def print_default():
        """Prints the default values of DeleteResults.
