...
from ansys.meshing.prime.core.volumesearch import VolumeQualitySummary
...
def local_model() -> Model:
    ...
    This imports the Prime server environment into the python process. It will
    error unless proper environment is setup to support Prime Server.
    '''
...
def __filter_internal_symbols(symbol):
    __internals = [ 
        'annotations', 'autogen', 'core', 'enum', 'internals', 'params', 'utils',
        'Any', 'List', 'Dict',
        'CommunicationManager', 'CoreObject'
    ]
