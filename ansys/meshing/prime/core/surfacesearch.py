...
class SurfaceQualitySummary( _SurfaceSearch):
    ...
    def __init__(self, model: CommunicationManager, parts : List[Part] = None, 
        ...
        scope : ScopeDefinition, optional
            Scope definition to scope the face zonelets to get surface quality summary. If specified will take precedence over parts. The default scope is face zonelets of all parts.
        ...
        face_quality_measures : List[FaceQualityMeasure], optional
            List of face quality measures for which to get surface quality summary. If specified will ignore a group defined by solver type.
